...
function htmlResponse(body: string): Response {
  ...
  let polishedBody = withAccountTools.replace("</style>", `${UI_POLISH_CSS}${DARK_MODE_CSS}${TABLE_POLISH_CSS}${FORM_LAYOUT_CSS}${TOPBAR_LAYOUT_CSS}${DARK_TEXT_CSS}${LOGIN_DARK_CSS}${FILE_ACTION_ALIGNMENT_CSS}</style>`);
