...
var FILE_ACTION_ALIGNMENT_CSS = `.file-actions form{grid-template-columns:minmax(0,1fr) 116px}.file-actions input[type=file]{display:block;min-width:0;width:100%;font-size:13px}.file-actions button{width:116px;min-width:116px}@media(max-width:720px){.file-actions form{grid-template-columns:minmax(0,1fr) 116px}}`;
